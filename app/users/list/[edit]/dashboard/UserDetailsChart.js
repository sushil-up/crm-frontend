...
function UserDetailsChart({ userData, projectId, startDate, endDate ,id }) {
      ...
      options: {
        ...
        onClick: function (evt) {
          ...
          if (activePoint.length > 0) {
            ...
            router.push(`/graphrecord/?startDate=${startDate}&endDate=${endDate}&projectId=${clickedUser.id}&userId=${id}`);
          }
        },
      },
    };
